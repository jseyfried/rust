...
impl File {
    ...
    pub fn read_at(&self, _buf: &mut [u8], _offset: u64) -> io::Result<usize> { Err(generic_error()) }
    ...
    pub fn write_at(&self, _buf: &[u8], _offset: u64) -> io::Result<usize> { Err(generic_error()) }
    ...
    pub fn set_permissions(&self, _: FilePermissions) -> io::Result<()> { Err(generic_error()) }
