            ...
            hir::ExprStruct(ref qpath, ref fields, ref base) => {
                ...
                if let Some(ref base) = *base {
                    ...
                    for field in fields {
                        ...
                        self.check_field(use_ctxt, field.span, adt, variant.field_named(field.name.node));
                    }
                }
            }
            _ => {}
        ...
        match pat.node {
            PatKind::Struct(ref qpath, ref fields, _) => {
                ...
                for field in fields {
                    ...
                    self.check_field(use_ctxt, field.span, adt, variant.field_named(field.node.name));
                }
            }
            _ => {}
        }
